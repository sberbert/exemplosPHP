  ...
  <body>
    ...
    <table border="1" cellspacing="0" cellpadding="5">
      <tr>
        <th>ID</th>
        <th>
            <a href="?ordem=nome&direcao=<?= $direcao == 'ASC' ? 'DESC' : 'ASC' ?>&nome=<?= $nome ?>&precoMin=<?= $precoMin ?>&quantidadeMin=<?= $quantidadeMin ?>">
                Nome
            </a>
        </th>

        <th>
            <a href="?ordem=preco&direcao=<?= $direcao == 'ASC' ? 'DESC' : 'ASC' ?>&nome=<?= $nome ?>&precoMin=<?= $precoMin ?>&quantidadeMin=<?= $quantidadeMin ?>">
                Preço
            </a>
        </th>

        <th>
            <a href="?ordem=quantidade&direcao=<?= $direcao == 'ASC' ? 'DESC' : 'ASC' ?>&nome=<?= $nome ?>&precoMin=<?= $precoMin ?>&quantidadeMin=<?= $quantidadeMin ?>">
                Quantidade
            </a>
        <th>Edição</th>
        <th>Exclusão</th>
